                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="page-header-tools">
                                        <a class="btn btn-gradient-01" href="{{route('banner.view')}}"> Banners List</a>
                                    </div>
                                    <div class="widget-body">
                                        <form class="form-horizontal" method="post" action="{{ route('banner.store') }}" id="myForm" enctype="multipart/form-data">
                                                @csrf

                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <form class="form-horizontal" method="post" action="{{ route('blog.update', $edits->id) }}" id="myForm" enctype="multipart/form-data">
                                                @csrf
                                            ...
                                            <div class="row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="mt-5 mb-5 position-relative">
                                                    <div class="group material-input">
                                                      <textarea name="description" id="description" cols="5" rows="15" class="form-control" placeholder = "Write description here">{{$edits->description}}</textarea>

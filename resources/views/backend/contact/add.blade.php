	                            ...
	                            <div class="d-flex align-items-center">
	                                ...
	                                <div>
			                            <ul class="breadcrumb">
			                                ...
			                                <li class="breadcrumb-item"><a href="{{url('contact.view')}}">Banners</a></li>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <form class="form-horizontal" method="post" action="{{ route('contact.store') }}" id="myForm" enctype="multipart/form-data">
                                                @csrf
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Mobile</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="mobile" placeholder="Write mobile here" class="form-control">
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="email" name="email" placeholder="Write email here" class="form-control">

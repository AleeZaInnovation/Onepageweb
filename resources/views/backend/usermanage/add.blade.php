                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <form class="form-horizontal" method="post" action="{{ route('user.store') }}" id="myForm" enctype="multipart/form-data" >
                                                @csrf
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="name" placeholder="Write name here" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Email & Password </label>
                                                <div class="col-lg-9">
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="mobile" placeholder="Write mobile no here" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Designation</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="designation" placeholder="Write designation here" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Address</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="address" placeholder="Write address here" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Gender</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="gender" placeholder="Write gender here" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">

	                            ...
	                            <div class="d-flex align-items-center">
	                                ...
	                                <div>
			                            <ul class="breadcrumb">
			                                ...
			                                <li class="breadcrumb-item"><a href="{{url('menu.view')}}">Menu</a></li>
                            ...
                            <div class="col-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="page-header-tools">
                                        <a class="btn btn-gradient-01" href="{{route('menu.view')}}"> Menu List</a>
                                    </div>
                                    <div class="widget-body">
                                        <form class="form-horizontal" method="post" action="{{ route('menu.update', $edits->id) }}" id="myForm" enctype="multipart/form-data">
                                                @csrf

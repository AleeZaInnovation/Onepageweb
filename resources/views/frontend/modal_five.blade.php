...
<div class="modal fade" id="Modalfive" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered modal-xl">
    <div class="modal-content">
      <div class="modal-header mb-4" style="background: #F2A12B;color:#fff">
        <h5 class="modal-title ps-4" id="exampleModalToggleLabel" >{{$blog[5]['title']}}</h5>
